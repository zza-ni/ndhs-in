  ...
  const items = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M5.5 20l4-5 1.8 2.3-4.2 5.2c-1.2 1.5-3.2-0.5-1.6-2.5Z"
            fill="currentColor"
          />
          <path
            d="M11.1 8.7c.4-1.2.2-2.2-.9-3.4L5.7 2.1c-.5-.6-1.5.2-1.1.9l2.7 3.3c.5.6-.5 1.5-1.1.8L2.9 3.7c-.5-.6-1.5.2-1 1l3.1 3.8c.5.6-.5 1.5-1.1.8L1.1 5.7c-.4-.5-1.1-.2-1.3.4-.2.6.3 1.1.6 1.6l4.2 5c1 .9 2.1 1.5 3.4 1.1.2-.1.4-.2.7-.4l8.7 11.2c.5.6 1.4.7 2 .2l.1-.1c.7-.6.8-1.6.2-2.3l-8.2-10.6c.3-.3.5-.6.6-.9Z"
            fill="currentColor"
          />
          <path
            d="M13.2 11.1l1.4-1.7c-2.2-3.7 2.7-8.1 5.7-5.6 3.1 2.7-1.2 8.5-3.7 7.3l-1.7 2.2-1.7-2.2Z"
            fill="currentColor"
          />
        </svg>
      ),
        ...
        if (it.to === "/board") {
          ...
          return (
            <NavLink
              key={it.to}
              to="/notice"
              className={`${navStyles.item} ${active ? navStyles.active : ""}`}
              onClick={() => {
